...
index = python.index("n")      # n 위치 찾기
print(index)
index = python.index("n", index + 1)  # 다음 n 찾기
print(index)

print(python.find("Java"))     # Java 찾기 (-1 반환 가능)
print(python.count("n"))       # n 개수 세기
